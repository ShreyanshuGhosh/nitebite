    ...
    <nav className={navbarClass}>
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Button 
            className="bg-nitebite-accent hover:bg-nitebite-accent-light text-white transition duration-300 focus-ring glassmorphic-button animate-glow"
            onClick={() => scrollToSection('category-section')}
          >
            Order Now
          </Button>
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <MenuItemAnimation>
                      <div className="mt-4 px-4">
                        <Button 
                          className="w-full glassmorphic-button py-5 rounded-md text-white font-medium animate-glow"
                          onClick={() => {
