        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link 
                to="/" 
                className={`font-medium transition-colors duration-300 ${location.pathname === '/' ? 'text-nitebite-yellow' : 'text-white hover:text-nitebite-purple'}`}
              >
                Home
              </Link>
              <Link 
                to="/snack-boxes" 
                className={`font-medium transition-colors duration-300 ${location.pathname === '/snack-boxes' ? 'text-nitebite-yellow' : 'text-white hover:text-nitebite-purple'}`}
              >
                Boxes
              </Link>
              <Link 
                to="/box-builder" 
                className={`font-medium transition-colors duration-300 ${location.pathname === '/box-builder' ? 'text-nitebite-yellow' : 'text-white hover:text-nitebite-purple'}`}
              >
                Build Your Box
              </Link>
              <Link 
                to="/products" 
                className={`font-medium transition-colors duration-300 ${location.pathname === '/products' ? 'text-nitebite-yellow' : 'text-white hover:text-nitebite-purple'}`}
              >
                All Items
              </Link>
            </nav>
          ...
          >
            <div className="container mx-auto px-4 py-4">
              <nav className="flex flex-col space-y-3">
                <Link
                  to="/"
                  className={`font-medium py-2 transition-colors duration-300 ${location.pathname === '/' ? 'text-nitebite-yellow' : 'text-white hover:text-nitebite-yellow'}`}
                ...
                <Link
                  to="/snack-boxes"
                  className={`font-medium py-2 transition-colors duration-300 ${location.pathname === '/snack-boxes' ? 'text-nitebite-yellow' : 'text-white hover:text-nitebite-yellow'}`}
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Boxes
                </Link>
                <Link
                  to="/box-builder"
                  className={`font-medium py-2 transition-colors duration-300 ${location.pathname === '/box-builder' ? 'text-nitebite-yellow' : 'text-white hover:text-nitebite-yellow'}`}
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Build Your Box
                </Link>
                <Link
                  to="/products"
                  className={`font-medium py-2 transition-colors duration-300 ${location.pathname === '/products' ? 'text-nitebite-yellow' : 'text-white hover:text-nitebite-yellow'}`}
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  All Items
                </Link>
