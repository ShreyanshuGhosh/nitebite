...
const Hero: React.FC = () => {
  return <div className="relative min-h-screen bg-nitebite-dark overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-screen page-container text-center px-4">
        <span className="inline-block px-4 py-2 bg-nitebite-accent/10 backdrop-blur-md border border-nitebite-accent/20 rounded-full text-sm text-nitebite-highlight mb-6 animate-fade-in" style={{
        animationDelay: '300ms'
      }}>
          Late night cravings? We've got you covered.
        </span>
        
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight animate-fade-in" style={{
        ...
        <p className="text-nitebite-text-muted max-w-2xl mb-10 text-lg animate-fade-in" style={{
        ...
        <div className="w-full max-w-lg glass-card p-6 rounded-2xl animate-fade-in-up" style={{
